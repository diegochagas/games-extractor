...
SITE_ART_NOTES = {
 ...
 "17173_xzsds09": (_XZ + "Armadura de Dourado (Peixe-Espada), versão feminina", "a mesma folha guardada na biblioteca Saint Seiya Cloth Schemes"),
 ...
 "17173_xzsds15": (_XZ + "Armadura do Dragão de Nove Cabeças, versão feminina", "a mesma folha guardada na biblioteca Saint Seiya Cloth Schemes"),
 "17173_xzsds16": (_XZ + "Armadura do Dragão de Nove Cabeças, versão masculina", "a mesma folha guardada na biblioteca"),
